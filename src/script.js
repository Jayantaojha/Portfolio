...
function showApps() {
    ...
    if (screen.width > 600) {
        headerDiv.innerHTML = '<i class="fa-solid fa-xmark" id="app-cross-icon" style="font-size: 22px; cursor: pointer"></i> <h3 style="padding-left: 42px">Apps</h3>';
    }
    else {
        headerDiv.innerHTML = '<i class="fa-solid fa-xmark" id="app-cross-icon" style="font-size: 22px; cursor: pointer"></i> <h3 style="padding-left: 24px">Apps</h3>';
    }
    ...
    contentDiv.innerHTML =
        `<a href="https://jayantaojha.github.io/Calendar/index.html"><div id="app1"><i class="fa-solid fa-calendar-days" style="font-size: 26px; margin-left: 12px; text-align: center; "></i><p style="font-size: 12px">Calendar</p></div></a>
